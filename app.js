function Random_Number() {
    ...
    if (inputValue == 'e') {
        document.getElementById("output").innerText = "DONT PUT A FUCKING "e" or "E". ARE YOU JACKSHIT CRAZY WTF ARE YOU DOING WITH YOUR LIFE GO DO SMTH PRODUCTIVE LIKE IDK TRANSLATE THIS MORSE CODE ". . . - - - . . . - - - . . . - - - . . . - -" MAYBE PLAYING WITH SOUND WILL HELP GL;
